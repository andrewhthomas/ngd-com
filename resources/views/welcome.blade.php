...
<head>
    ...
    <title>Ninth Gear Dev - Drupal, WordPress, and Laravel Dev Shop</title>
    ...
    <script src="https://use.typekit.net/fgq3gik.js"></script>
    <script>try{Typekit.load({ async: true });}catch(e){}</script>
    <link rel="stylesheet" type="text/css" href="https://cloud.typography.com/6008232/7255152/css/fonts.css" />
</head>
<body id="top">
    <!--[if lt IE 8]>
                    ...
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                ...
                                <li><a href="#download" class="btn-white btn-small">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="navicon">
